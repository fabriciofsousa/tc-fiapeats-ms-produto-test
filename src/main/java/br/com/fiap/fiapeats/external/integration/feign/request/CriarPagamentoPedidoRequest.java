...
public class CriarPagamentoPedidoRequest {
    ...
    public CriarPagamentoPedidoRequest(String id, String urlNotificacao, BigDecimal valorTotal, List<ProdutosPedidoRequest> itens) {
        this.id = id;
        this.nome = "pedido-compo";
        this.descricao = "pedido-compo";
        this.urlNotificacao = urlNotificacao;
        this.dataExpiracao = LocalDateTime.now().plusDays(1).format(DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.000-00:00"));

...
public class ProdutoSpringController {
  ...
  @Autowired private CriarProdutoUseCase criarProdutoUseCase;
  @Autowired private EditarProdutoUseCase editarProdutoUseCase;
  @Autowired private ExcluirProdutoUseCase excluirProdutoUseCase;
  @Autowired private ListarProdutosUseCase listarProdutos;
  @Autowired private ListarProdutosPorCategoriaUseCase listarProdutosPorCategoriaUseCase;
  ...
  public ResponseEntity<List<ProdutoResponse>> consultarProdutoPorCategoria(
    ...
    return ResponseEntity.ok(
        listarProdutosPorCategoriaUseCase.listarProdutosPorCategoria(categoria).stream()
            .map(
                p ->
                    ProdutoResponse.builder()
                        .id(p.getId())

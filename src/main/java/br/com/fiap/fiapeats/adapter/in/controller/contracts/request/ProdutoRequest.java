...
public class ProdutoRequest {
    ...
    @Schema(description = "url da imagem do produto", example = "https://static.itdg.com.br/images/1200-630/150ba2d5d2874bed8561dd8edbdc1323/164773-original.jpg")
    private String imagemUrl;

    public ProdutoRequest(String nome, String descricao, BigDecimal valor, String categoria, String imagemUrl) {
        this.nome = nome;
